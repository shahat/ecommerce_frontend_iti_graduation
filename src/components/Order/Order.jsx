...
function Order() {
  ...
  console.log(date);
  return (
      (!order.shippingAddress)?<div className="container" aria-hidden="true">
        ...
        <div className="row justify-content-around align-items-center">
          ...
          <div className="col-12 my-2">
            <button className="btn btn-outline-primary me-1 placeholder " aria-disabled="true" disabled>
              Order Again  <RiLoopRightFill/>
            </button>
            <button className="btn btn-outline-primary mx-1 placeholder " aria-disabled="true" disabled>
              Contact Support  <RiCustomerService2Line/>
            </button>
          </div>
          <div className="row justify-content-around align-items-center" aria-hidden="true">
                <div className="col-3 ">
                ...
                <div className="col-3 text-center">
                  <button className="btn btn-outline-success" onClick={()=>{navigate(`/products/${item.productId._id}`)}}>
                    View Product
                  </button>
        ...
        <div className="row justify-content-around align-items-center">
          ...
          {order.items.map((item,index)=>(
            <div className="col-12 my-1 border" key={index}>
              <div className="row justify-content-around align-items-center">
                <div className="col-3 ">
                  <img src={item.productId.thumbnail} className="img-fluid w-50" alt="" />
                  <p className="lead">
