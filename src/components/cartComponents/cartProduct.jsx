  ...
  return (
    <>
      <div className={`${css["single_product"]} w-100 d-flex flex-wrap`}>
        <div className={`${css["cart_product_left"]} float-start d-flex col-9`}>
          {/* Card Image */}
          <div
          ...
          <div className="d-flex align-items-center fw-semibold">
            ...
            {!inputField ? (
              ...
              >
                ...
                {list.map((i) => {
                  return (
                    <option key={i} value={i} className="fw-semibold">
                      {i}
                    </option>
                  );
                })}
                <hr />
                <option className="fw-semibold" value={11}>
                  +10
                </option>
              </select>
            ) : (
                ...
                <input
                  ...
                  onBlur={(e) => {
                    if (e.target.value > 0 && e.target.value) {
                      priceEnter(e, Number(e.target.value));
                    } else {
                      setInput(false);
                    }
                  }}
