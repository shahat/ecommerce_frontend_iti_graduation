  ...
  return (
    <div className={`container ${styles.manageMyAccount}`}>
      <div className="row m-0 p-0 justify-content-around align-items-center">
        <div
          className={`col-12 col-sm-12 col-md-4 col-lg-5 ${styles.manageLinks}`}
          id="manageLinks"
        >
          <h5 className="h6">Manage My Account</h5>
        ...
        <div className="col-12 col-sm-12 col-md-6 col-lg-7">
          <div
            className={`row justify-content-center align-items-center ${styles.cardHolder}`}
          >
